...
Item.create!(
  [
    ...
    {
      name: "三味線",
      description:"三味線です。20年戦士ですがまだまだいい音鳴らしてます",
      bland: "難波工芸社",
      size: "L",
      condition: "中古。傷あり",
      delivery_fee: "送料込み",
      delivery_day: "7日以内に発送",
      price: 12000, 
      is_deleted: 0,
      user_id: 2,
      category_id: 818,
    ...
    {
      name: "ダウンジャケット　MONCLER",
      description:"冬の定番ダウンジャケット。最高峰の暖かさをあなたに。MONCLERが提案する快適な冬の過ごし方。",
      bland: "MONCLER",
      size: "L",
      condition: "目立った汚れなし",
      delivery_fee: "送料込み",
